...
\Rfunction{invariantset} (-> \Rfunction{normalizeAffyBatchInvariantsetPara}) and \Rfunction{quantile}
(-> \Rfunction{normalizeAffyBatchQuantilesPara}) available from the \Rpackage{affy} package in the function
\Rfunction{normalize}.
