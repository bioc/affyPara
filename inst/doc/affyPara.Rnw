...
\and Ulrich Mansmann \footnote{Chair of Biometrics and Bioinformatics, IBE, University of Munich, 81377 Munich, Germany}
}
...
\begin{itemize}
\item Bug fix for cluster with one node.
\end{itemize}
